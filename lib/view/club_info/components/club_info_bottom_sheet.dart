...
class ClubInfoBottomSheet extends ConsumerWidget {
    ...
    return SizedBox(
      ...
      child: FutureBuilder(
        ...
        builder: (context, clubListSnapshot) {
          final bool isLoading = clubListSnapshot.connectionState == ConnectionState.waiting;

          final clubList = isLoading ? _generateFakeClub(5) : clubListSnapshot.data;
            ...
            itemBuilder: (context, index) {
              if (index == 0) {
                ...
                return CustomLoadingSkeleton(
                  isLoading: isLoading,
                  child: ClubInfoListListTile(club: club, isCurrent: isCurrent),
                );
              } else {
                return Column(
                  children: [
  ...
  List<Club> _generateFakeClub(int count) {
